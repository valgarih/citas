...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT a.*,d.doctor AS nombre_doctor FROM `appointments`  a INNER JOIN doctor_settings d ON d.id = a.doctor_settings_id WHERE a.id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
    ...
    <div class="row" id="appointment">
        ...
        <div class="col-6">
            ...
            <?php if($_settings->userdata('id') > 0): ?>
            <div class="form-group">
                <label for="doctor_settings_id" class="control-label">Doctor Asignado</label>
                <select name="doctor_settings_id" id="doctor_settings_id" class="custom custom-select">
                    <option value="1"<?php echo isset($doctor_settings_id) && $doctor_settings_id == "1" ? "selected": "" ?>>Damian</option>
                    <option value="2"<?php echo isset($doctor_settings_id) && $doctor_settings_id == "2" ? "selected": "" ?>>Jose</option>
                    <option value="3"<?php echo isset($doctor_settings_id) && $doctor_settings_id == "3" ? "selected": "" ?>>Yuriko</option>
                </select>
            </div>
            <?php else: ?>
                <input type="hidden" name="doctor_settings_id" value="0">
            <?php endif; ?>
        </div>
