        ...
        <div class="container-fluid">
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT 	p.*,a.date_sched,a.status,a.id AS aid,d.`doctor` FROM `patient_list` p INNER JOIN `appointments` a ON p.id = a.patient_id INNER JOIN `doctor_settings` d ON a.doctor_settings_id = d.id ORDER BY UNIX_TIMESTAMP(a.date_sched) DESC ");
